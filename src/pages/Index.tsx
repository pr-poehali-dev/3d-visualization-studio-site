...
const projects = [
  ...
  {
    id: 2,
    title: 'Апартаменты Staheev',
    category: 'Архитектура',
    year: '2024',
    images: [
      'https://cdn.poehali.dev/files/c_002 copy.jpg',
      'https://cdn.poehali.dev/files/c_003 copy.jpg',
      'https://cdn.poehali.dev/files/c_005 copy.jpg',
      'https://cdn.poehali.dev/files/c_001 copy.jpg',
      'https://cdn.poehali.dev/files/c_007 copy.jpg'
    ],
    description: 'Премиальный жилой комплекс на побережье с панорамными видами на море и горы. Современная архитектура с использованием стекла, меди и натурального камня. Инфинити-бассейн, приватные террасы, озеленённые атриумы и эксклюзивная инфраструктура класса люкс.'
  }
];
